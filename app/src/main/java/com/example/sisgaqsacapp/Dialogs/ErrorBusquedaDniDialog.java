...
public class ErrorBusquedaDniDialog {
    public ErrorBusquedaDniDialog(final Context contexto){
        final Dialog dialogo= new Dialog(contexto);
        dialogo.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialogo.setCancelable(false);
        dialogo.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialogo.setContentView(R.layout.dialog_error_busqueda_dni);
        Button okey= (Button) dialogo.findViewById(R.id.ImgBtnOkErrorBusqueda);
        Button reportar= (Button) dialogo.findViewById(R.id.ImgBtnReporteErrorBusqueda);
